...
class LaminaProcesador_IV extends JPanel{
	...
	configura_barra("src/graficos/subrra.gif").addActionListener(new StyledEditorKit.UnderlineAction());
	...
	JButton negritaBarra, cursivaBarra, subraBarra, azulBarra,
	rojoBarra, amarilloBarra, a_izquierda, a_centrado, a_derecha,
	a_justificado;
